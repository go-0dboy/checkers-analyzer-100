/* ============================================================
 * PDN (Portable Draughts Notation) — разбор и сериализация партии.
 * Мульти-партийный разбор для обучения нейросети — в nntrain.ts.
 * ============================================================ */
